...
export const Home = () => {
    ...
    return (
        <>
            {
                showModal &&
                <Model text="Create Account" setIsRegistering={setIsRegistering} setShowModal={setShowModal} showModal={showModal} isRegistering={isRegistering} Component={() => <Auth isRegistering={isRegistering} setIsRegistering={setIsRegistering} />} />
            }
